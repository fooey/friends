...
var _ref13 = React.createElement(
    ...
    React.createElement(
        'p',
        null,
        'For this project, I\'d probably keep it HTML based, and try to do something roughly like a directory tree. The cleanest way, for both usability and implentation, is probably to let a user drill down manually and allow them to follow the paths and loops in whatever order they find most interesting.'
    ),
    React.createElement(
        'p',
        null,
